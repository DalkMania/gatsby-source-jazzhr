 ...
 */
async function createGraphQLNode(ent, type, createNode, store, cache, createContentDigest) {
...
export function createNodesFromEntities({ entities, createNode, createContentDigest }) {
    entities.forEach((e) => {
        const { ...entity } = e;
        const node = {
            ...entity,
